...
export const teachersData = [
  {
    ...
    classes: ["1ب", "2أ", "3ج"],
    address: "123 شارع الرئيسي، أي مدينة، الولايات المتحدة",
  },
  {
    id: 2,
    teacherId: "1234567890",
...
export const transformedClasses = [
  {
    id: 1,
    className: "1A",
    courses: [
      { courseName: "Math", numberOfSubscribedStudents: 15 },
      { courseName: "Science", numberOfSubscribedStudents: 12 },
    ],
  },
  {
    id: 2,
    className: "2B",
    courses: [
      { courseName: "History", numberOfSubscribedStudents: 20 },
      { courseName: "Geography", numberOfSubscribedStudents: 18 },
    ],
  },
  {
    id: 3,
    className: "3C",
    courses: [
      { courseName: "Art", numberOfSubscribedStudents: 10 },
      { courseName: "Physical Education", numberOfSubscribedStudents: 16 },
    ],
  },
