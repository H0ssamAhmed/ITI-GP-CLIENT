...
const Exam = () => {
  ...
  useEffect(() => {
    ...
    // const quizTime = sessionStorage.getItem("quizTime")
    // if (sessionData) {
    //   console.log(quizTime);

    //   setAllQuestions(JSON.parse(sessionData));
    // } else {
    //   sessionStorage.setItem("quiz", JSON.stringify(initializedQuestions))
  ...
  const saveDataAndRedirect = () => {
    ...
    setIsQuizEnd(true)
    sessionStorage.setItem("quizData", JSON.stringify(allQuestions))
    setTimeout(() => {
          ...
          <AnimatePresence>
            {!isStarted &&
              <motion.div
                ...
                <Typography variant='h2' sx={{ fontWeight: "bold", padding: "1rem 0", margin: "1rem 0" }}>اختبار الرياضيات</Typography>

                <Typography variant='h2' sx={{ fontWeight: "semibold", padding: "1rem 0", margin: "1rem 0" }} >وقت الامتحان <span className='text-brand-500 font-extrabold' > {30} </span>دقيقة </Typography>
          ...
          <AnimatePresence>
            ...
            {isQuizEnd &&
              ...
              >
                ...
                <Typography variant='h2' sx={{ fontWeight: "bold", padding: "1rem 0", margin: "1rem 0" }}>جاري تحميل اجاباتك.....</Typography>
                <Typography variant='h2' sx={{ fontWeight: "bold", padding: "1rem 0", margin: "1rem 0" }}>
                  <Link to="/courses/review/:examId">
                    راجع اجاباتك
                  </Link>
                ...
                <CircularProgress />
                {/* <Skeleton variant="rounded" sx={{ margin: "0 auto" }} component={} width={210} height={60} /> */}
              </motion.div>
            }
            {ShowAlertSubmit &&
              <motion.div
                ...
                <Stack sx={{
                  ...
                  <Stack
                    ...
                    <Button
                      ...
                      sx={{ fontSize: 20, padding: "0.5rem 1rem", color: "white" }} size='large' color='warning' variant="contained" endIcon={<SendIcon sx={{ margin: "0 1rem", rotate: "-180deg" }} />}>ارسال</Button>
                  </Stack>
                </Stack>
