  ...
  return (
    <div className="relative rounded-[1.6rem] mx-auto bg-brand-200 text-brand-900 w-[25.5rem] flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-between w-full px-8 py-4 mt-4">
        <Link to={"/courses/5"} className="bg-brand-400 hover:bg-brand-900 transition-all rounded-lg text-white px-4 py-2 text-center capitalize text-2xl" >المزيد</Link>
        <Link to={"/courses/5"} className="bg-yellow-500 hover:bg-yellow-700 transition-all rounded-lg text-black hover:text-white px-4 py-2 text-center capitalize text-2xl" >اشترك الان</Link>
